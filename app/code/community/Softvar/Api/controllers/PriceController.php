<?php
class Softvar_Api_PriceController extends Softvar_Api_Controller_Abstract 
{
	...
	public function itemsAction() {
		try {
			...
			$result = Mage::getModel('softvar/price_api')->items($post->offset);
		} catch(Exception $e) {
	...
	public function updateAction() {
		try {
			...
			$result = Mage::getModel('softvar/price_api')->update($post);
		} catch(Exception $e) {
			$result['success'] =  false;
			$result['msg'] = $e->getMessage();
		}
