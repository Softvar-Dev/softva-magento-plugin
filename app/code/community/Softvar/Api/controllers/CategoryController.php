<?php
class Softvar_Api_CategoryController extends Softvar_Api_Controller_Abstract 
{
	...
	public function itemsAction() {
		try {
			...
			$result = Mage::getModel('softvar/category_api')->items($post->offset, $post->magento_ids);
	...
	public function createAction() {
		try {
			...
			$result = Mage::getModel('softvar/category_api')->create($post);
